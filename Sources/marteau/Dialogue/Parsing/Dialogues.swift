...
public struct Dialogue: DialogueUnit, Speakable {
...
public struct Narration: DialogueUnit, Speakable {
...
public struct Question: DialogueUnit {
...
public struct Choice: DialogueUnit {
    public var type: DialogueType { .choice }
    public let choice: String
    public let dialogue: [DialogueUnit]
}

/// A no-op dialogue interaction for commentary.
public struct Comment: DialogueUnit {
